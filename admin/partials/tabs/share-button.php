        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td>
                            ...
                            <li class="lightshare-social-network-<?php echo esc_attr($network); ?> <?php echo $is_active ? 'active' : ''; ?>" data-network="<?php echo esc_attr($network); ?>">
                                <label for="lightshare-share-social-network-input-<?php echo esc_attr($network); ?>" class="<?php echo $is_active ? 'active' : ''; ?>">
                                    ...
                                    <input type="checkbox"
                                        ...
                                        name="lightshare[share][social_networks][]"
                    ...
                    <input type="hidden" id="lightshare_social_networks_order" name="lightshare[share][social_networks_order]" value="<?php echo esc_attr(json_encode(array_keys($ordered_networks))); ?>">
                </td>
            </tr>
