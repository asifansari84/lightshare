		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[remove_comment_urls]" value="1" <?php checked(1, LS_Options::get_option('remove_comment_urls'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[disable_dashicons]" value="1" <?php checked(1, LS_Options::get_option('disable_dashicons'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[disable_embeds]" value="1" <?php checked(1, LS_Options::get_option('disable_embeds'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[disable_xmlrpc]" value="1" <?php checked(1, LS_Options::get_option('disable_xmlrpc'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[disable_emojis]" value="1" <?php checked(1, LS_Options::get_option('disable_emojis'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[remove_jquery_migrate]" value="1" <?php checked(1, LS_Options::get_option('remove_jquery_migrate'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[disable_rss_feeds]" value="1" <?php checked(1, LS_Options::get_option('disable_rss_feeds'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[remove_rsd_link]" value="1" <?php checked(1, LS_Options::get_option('remove_rsd_link'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[hide_wp_version]" value="1" <?php checked(1, LS_Options::get_option('hide_wp_version'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[remove_global_styles]" value="1" <?php checked(1, LS_Options::get_option('remove_global_styles'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[separate_block_styles]" value="1" <?php checked(1, LS_Options::get_option('separate_block_styles'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[disable_self_pingbacks]" value="1" <?php checked(1, LS_Options::get_option('disable_self_pingbacks'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[disable_google_maps]" value="1" <?php checked(1, LS_Options::get_option('disable_google_maps'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[remove_shortlink]" value="1" <?php checked(1, LS_Options::get_option('remove_shortlink'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<div class="checkbox-radio">
						<label>
							<input type="checkbox" name="lightshare_options[remove_rest_api_links]" value="1" <?php checked(1, LS_Options::get_option('remove_rest_api_links'), true); ?> />
						</label>
			...
			<tr valign="top">
				...
				<td>
					<select name="lightshare_options[disable_heartbeat]" id="lightshare_disable_heartbeat">
						<option value>Default</option>
						<option value="disable_everywhere" <?php selected(LS_Options::get_option('disable_heartbeat'), 'disable_everywhere'); ?>>Disable Everywhere</option>
						<option value="allow_posts" <?php selected(LS_Options::get_option('disable_heartbeat'), 'allow_posts'); ?>>Only Allow When Editing Posts/Pages</option>
					</select>
			...
			<tr valign="top">
				...
				<td>
					<select name="lightshare_options[heartbeat_frequency]" id="lightshare_heartbeat_frequency">
						<option value>15 Seconds (Default)</option>
						<option value="30" <?php selected(LS_Options::get_option('heartbeat_frequency'), 30); ?>>30 Seconds</option>
						<option value="45" <?php selected(LS_Options::get_option('heartbeat_frequency'), 45); ?>>45 Seconds</option>
						<option value="60" <?php selected(LS_Options::get_option('heartbeat_frequency'), 60); ?>>60 Seconds</option>
					</select>
			...
			<tr valign="top">
				...
				<td>
					<select name="lightshare_options[autosave_interval]" id="lightshare_autosave_interval">
						<option value>1 Minute (Default)</option>
						<option value="172800" <?php selected(LS_Options::get_option('autosave_interval'), 172800); ?>>Disable Autosave Interval</option>
						<option value="2" <?php selected(LS_Options::get_option('autosave_interval'), 2); ?>>2 Minutes</option>
						<option value="3" <?php selected(LS_Options::get_option('autosave_interval'), 3); ?>>3 Minutes</option>
						<option value="4" <?php selected(LS_Options::get_option('autosave_interval'), 4); ?>>4 Minutes</option>
						<option value="5" <?php selected(LS_Options::get_option('autosave_interval'), 5); ?>>5 Minutes</option>
						<option value="10" <?php selected(LS_Options::get_option('autosave_interval'), 10); ?>>10 Minutes</option>
						<option value="15" <?php selected(LS_Options::get_option('autosave_interval'), 15); ?>>15 Minutes</option>
						<option value="20" <?php selected(LS_Options::get_option('autosave_interval'), 20); ?>>20 Minutes</option>
					</select>
